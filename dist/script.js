...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postFormData('assets/server.php', formData).then(function (res) {
        console.log(res);
...
var modals = function modals() {
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // bindModalByTime('.popup', 60000);
};
